                        ...
                        if (!empty($materiais)):
                            ...
                            foreach ($materiais as $material):
                                ...
                                <tr>
                                    ...
                                    <td><?= $material['data_cad_est_caixa_hmy']; ?></td>
                                    <td>
                                        <a class="btn btn-warning btn-xs" href="<?= base_url('editar-funcionario/' . $material['id_est_caixa_hmy']) ?>">Visualizar</a>
                                        <button class="btn btn-danger btn-xs confirma_exclusao" href="#" data-id="<?= $material['id_est_caixa_hmy'] ?>" data-nome="<?= $material['id_est_caixa_hmy'] ?>">Deletar</button>
                                    </td>
                                </tr>
                                <?php
