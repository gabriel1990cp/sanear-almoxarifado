    ...
    <div class="row">
        <form action="<?= base_url('estoque/entrada_estoque_cxhm') ?>" method="post" enctype="multipart/form-data" id="entrada_estoque" class="entrada_estoque">
            ...
            <div class="hm-y">
                ...
                <div class="form-group col-md-4">
                    <button type="button" class="btn btn-primary btn-block cadastrar-hm btn-hm-y">Adicionar</button>
                </div>
            </div>

            <div class="hm-abcd">
                <div class="form-group col-md-4">
                    <label for="inicio_caixa_hm">Número *</label>
                    <input type="text" class="form-control" id="inicio_caixa_hm" name="inicio_caixa_hm">
                </div>
                <div class="form-group col-md-4">
                    <button type="button" class="btn btn-primary btn-block cadastrar-hm btn-hm-abcd">Adicionar</button>
                </div>
            </div>
        </form>
        ...
        $(".btn-hm-y").click(function () {
            ...
            if (erro == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {inicio_caixa_hm: inicio_caixa_hm, fim_caixa_hm: fim_caixa_hm, id_entrada_material: id_entrada_material},
