                    ...
                    if (!empty($entradasEstoque)):
                        foreach ($entradasEstoque as $entradaEstoque):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($entradaEstoque['status_est_entrada'] != 'finalizado'):
                                        ?>
                                        <a class="btn btn-primary btn-xs" href="<?= base_url('entrada-material/' . $entradaEstoque['id_est_entrada']) ?>">Gerenciar</a>
